  ...
  private function EncodeFile($path, $encoding = 'base64') {
    try {
      ...
      if (PHP_VERSION < 6) {
        ...
        //set_magic_quotes_runtime(0); código obsoleto en la versiones superiores a 5.3
		ini_set("magic_quotes_runtime", 0);
      }
      $file_buffer  = file_get_contents($path);
      $file_buffer  = $this->EncodeString($file_buffer, $encoding);
      if (PHP_VERSION < 6) { 
	  //set_magic_quotes_runtime($magic_quotes); código obsoleto en la versiones superiores a 5.3
